...
import hashlib
R=Path(__file__).resolve().parents[1]; O=R/'results'/'phase0c_v02'; O.mkdir(parents=True,exist_ok=True)
inc=[]
...
for n in ['README_FIRST.md','PREREGISTRATION.md','SCIENTIFIC_CONTRACT.md','RATIONALE_THREE_LAYER.md','PRE_RUN_FREEZE.json','run_phase0c.py','local_runner.py','.gitignore']:
    p=R/n
