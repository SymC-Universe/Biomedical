...
| Methylation annotation / feature representation | Exact annotation/build, mapping, regulatory-region, multi-mapping, unmapped, feature-reduction, and null rules must be frozen before any methylation association | **Active prospective scientific gate** | not yet frozen | no biological implementation allowed yet | none | pending explicit design freeze |
| Methylation biological relationship | No methylation-RNA/protein/genomic/outcome relationship is yet admitted | Not started | annotation + Stage C1 analysis protocol must be frozen before association | not yet implemented | none | prospective |
| Modal + scalar + conglomeration | Future methylation analysis must retain mode-resolved structure, separately licensed scalar compression, and whole-system/conglomeration organization as complementary views | Prospective design constraint | encoded in C0/C0.1 and B2 closure | C1 pending | none | active design boundary |
...
- annotation choices may not be selected because they improve downstream agreement;
