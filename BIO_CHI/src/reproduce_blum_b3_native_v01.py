...
def main() -> None:
    ...
    if t.size != 91 or not np.allclose(t,np.arange(0,182,2,dtype=float),rtol=0,atol=0):
        raise SystemExit("BLUM_B3_UNEXPECTED_TIME_GRID")
    ...
    result={
        ...
        "freeze":"BIO_CHI/config/BLUM_B3_TRANSPORT_SOURCE_FREEZE_v0_1.json",
        "epistemic_mode":"P0-Q",
    ...
    (outdir/"blum_b3_native_reproduction_v0_1.json").write_text(json.dumps(result,indent=2)+"\n")
