...
cfg=json.loads((ROOT/"BIO_CHI/config/BIO_CHI_TOPDOWN_SYSTEM_SELECTION_FREEZE_v0_4.json").read_text())
survivors=[]
...
out={
  "schema_version":"0.4","status":status,"selected_system":selected,
...
p=ROOT/"BIO_CHI/artifacts/generated/topdown_system_selection_v0_4.json"
...
print("BIO_CHI_TOPDOWN_SYSTEM_SELECTION_V04_DONE")
