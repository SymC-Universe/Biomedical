...
cfg=json.loads((ROOT/"BIO_CHI/config/BIO_CHI_TOPDOWN_SYSTEM_SELECTION_FREEZE_v0_2.json").read_text())
survivors=[]
...
out={
  "schema_version":"0.2","status":status,"selected_system":selected,
...
p=ROOT/"BIO_CHI/artifacts/generated/topdown_system_selection_v0_2.json"
...
print("BIO_CHI_TOPDOWN_SYSTEM_SELECTION_V02_DONE")
